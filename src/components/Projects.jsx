...
const Projects = () => {
  return (
    <>
      <div className=" w-full bg-[#161513] flex items-center p-12 justify-center">
        <div className="max-w-[1440px] flex  mx-auto w-full flex-col items-center">
          ...
          <div className=" flex flex-col sm:flex-row gap-4 md:gap-8 items-center mt-12 text-[#fff]">
            <div className=" bg-[#2A2A2A] rounded-2xl ">
              <img src={project1} alt="" />
              <div className=" flex justify-between items-center">
                <div className=" flex flex-col uppercase p-2 sm:p-4">
